...
export namespace Prisma {
  ...
  */
  ...
  export type UserExternalCountOutputTypeGetPayload<
    S extends boolean | null | undefined | UserExternalCountOutputTypeArgs
  > = S extends { select: any; include: any }
    ...
    ? {
        [P in TruthyKeys<
          S["select"]
        >]: P extends keyof UserExternalCountOutputType
          ? UserExternalCountOutputType[P]
          : never;
      }
    : UserExternalCountOutputType;
  ...
  export type CoWorkCountOutputTypeGetPayload<
    S extends boolean | null | undefined | CoWorkCountOutputTypeArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends keyof CoWorkCountOutputType
          ? CoWorkCountOutputType[P]
          : never;
      }
    : CoWorkCountOutputType;
  ...
  > = S extends { select: any; include: any }
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends keyof RoomCountOutputType
          ? RoomCountOutputType[P]
          : never;
      }
    : RoomCountOutputType;
  ...
  export type RoomRateCountOutputTypeGetPayload<
    S extends boolean | null | undefined | RoomRateCountOutputTypeArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends keyof RoomRateCountOutputType
          ? RoomRateCountOutputType[P]
          : never;
      }
    : RoomRateCountOutputType;
  ...
  export type DurationCategoryCountOutputTypeGetPayload<
    S extends boolean | null | undefined | DurationCategoryCountOutputTypeArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ...
    ? {
        [P in TruthyKeys<
          S["select"]
        >]: P extends keyof DurationCategoryCountOutputType
          ? DurationCategoryCountOutputType[P]
          : never;
      }
    : DurationCategoryCountOutputType;
  ...
  export type FacilityCountOutputTypeGetPayload<
    S extends boolean | null | undefined | FacilityCountOutputTypeArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends keyof FacilityCountOutputType
          ? FacilityCountOutputType[P]
          : never;
      }
    : FacilityCountOutputType;
  ...
  export type VertifyBookingCodeCountOutputTypeGetPayload<
    S extends boolean | null | undefined | VertifyBookingCodeCountOutputTypeArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ...
    ? {
        [P in TruthyKeys<
          S["select"]
        >]: P extends keyof VertifyBookingCodeCountOutputType
          ? VertifyBookingCodeCountOutputType[P]
          : never;
      }
    : VertifyBookingCodeCountOutputType;
  ...
  export type GetUserExternalAggregateType<
    T extends UserExternalAggregateArgs
  > = {
  ...
  type GetUserExternalGroupByPayload<T extends UserExternalGroupByArgs> =
    Prisma.PrismaPromise<
      Array<
        PickArray<UserExternalGroupByOutputType, T["by"]> & {
          [P in keyof T &
            keyof UserExternalGroupByOutputType]: P extends "_count"
            ? T[P] extends boolean
              ? number
  ...
  export type UserExternalGetPayload<
    S extends boolean | null | undefined | UserExternalArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? UserExternal
    ...
    ? UserExternal & {
        [P in TruthyKeys<S["include"]>]: P extends "BookRoom"
          ? Array<BookRoomGetPayload<S["include"][P]>>
          : P extends "_count"
          ? UserExternalCountOutputTypeGetPayload<S["include"][P]>
          : never;
      }
    : S extends { select: any } & (UserExternalArgs | UserExternalFindManyArgs)
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "BookRoom"
          ? Array<BookRoomGetPayload<S["select"][P]>>
          : P extends "_count"
          ? UserExternalCountOutputTypeGetPayload<S["select"][P]>
          : P extends keyof UserExternal
          ? UserExternal[P]
          : never;
      }
    : UserExternal;

  type UserExternalCountArgs = Omit<
    UserExternalFindManyArgs,
    "select" | "include"
  > & {
    select?: UserExternalCountAggregateInputType | true;
  };

  export interface UserExternalDelegate<
  ...
  > {
     ...
     **/
    findUnique<
      T extends UserExternalFindUniqueArgs,
    ...
    > extends True
      ...
      : Prisma__UserExternalClient<UserExternalGetPayload<T> | null, null>;
     ...
     **/
    findFirst<
      T extends UserExternalFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
     ...
     * })
     **/
    aggregate<T extends UserExternalAggregateArgs>(
      args: Subset<T, UserExternalAggregateArgs>
    ): Prisma.PrismaPromise<GetUserExternalAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, UserExternalGroupByArgs, OrderByArg> &
        InputErrors
    ): {} extends InputErrors
      ? GetUserExternalGroupByPayload<T>
   ...
   */
  export class Prisma__UserExternalClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    ...
    BookRoom<T extends UserExternal$BookRoomArgs = {}>(
      args?: Subset<T, UserExternal$BookRoomArgs>
    ): Prisma.PrismaPromise<Array<BookRoomGetPayload<T>> | Null>;
   ...
   */
  export interface UserExternalFindUniqueArgs
    extends UserExternalFindUniqueArgsBase {
    /**
   ...
   */
  export interface UserExternalFindFirstArgs
    extends UserExternalFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
  ...
  export type UserExternalUpdateManyArgs = {
     ...
     */
    data: XOR<
      UserExternalUpdateManyMutationInput,
      UserExternalUncheckedUpdateManyInput
    >;
    /**
  ...
  type GetCoWorkGroupByPayload<T extends CoWorkGroupByArgs> =
    Prisma.PrismaPromise<
      Array<
  ...
  export type CoWorkGetPayload<
    S extends boolean | null | undefined | CoWorkArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? CoWork
    ...
    ? CoWork & {
        [P in TruthyKeys<S["include"]>]: P extends "BranchToRoom"
          ? Array<BranchToRoomGetPayload<S["include"][P]>>
          : P extends "FacilityToCoWork"
          ? Array<FacilityToCoWorkGetPayload<S["include"][P]>>
          : P extends "userInternal"
          ? UserInternalGetPayload<S["include"][P]> | null
          : P extends "bookRoom"
          ? Array<BookRoomGetPayload<S["include"][P]>>
          : P extends "Close"
          ? CloseGetPayload<S["include"][P]> | null
          : P extends "Open"
          ? OpenGetPayload<S["include"][P]> | null
          : P extends "OpenClose24Hours"
          ? OpenClose24HoursGetPayload<S["include"][P]> | null
          : P extends "OpenCloseBoolean"
          ? OpenCloseBooleanGetPayload<S["include"][P]> | null
          : P extends "_count"
          ? CoWorkCountOutputTypeGetPayload<S["include"][P]>
          : never;
      }
    : S extends { select: any } & (CoWorkArgs | CoWorkFindManyArgs)
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "BranchToRoom"
          ? Array<BranchToRoomGetPayload<S["select"][P]>>
          : P extends "FacilityToCoWork"
          ? Array<FacilityToCoWorkGetPayload<S["select"][P]>>
          : P extends "userInternal"
          ? UserInternalGetPayload<S["select"][P]> | null
          : P extends "bookRoom"
          ? Array<BookRoomGetPayload<S["select"][P]>>
          : P extends "Close"
          ? CloseGetPayload<S["select"][P]> | null
          : P extends "Open"
          ? OpenGetPayload<S["select"][P]> | null
          : P extends "OpenClose24Hours"
          ? OpenClose24HoursGetPayload<S["select"][P]> | null
          : P extends "OpenCloseBoolean"
          ? OpenCloseBooleanGetPayload<S["select"][P]> | null
          : P extends "_count"
          ? CoWorkCountOutputTypeGetPayload<S["select"][P]>
          : P extends keyof CoWork
          ? CoWork[P]
          : never;
      }
    : CoWork;

  type CoWorkCountArgs = Omit<CoWorkFindManyArgs, "select" | "include"> & {
    select?: CoWorkCountAggregateInputType | true;
  };

  export interface CoWorkDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends CoWorkFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    > extends True
      ...
      : Prisma__CoWorkClient<CoWorkGetPayload<T> | null, null>;
     ...
     * })
     **/
    aggregate<T extends CoWorkAggregateArgs>(
      args: Subset<T, CoWorkAggregateArgs>
    ): Prisma.PrismaPromise<GetCoWorkAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, CoWorkGroupByArgs, OrderByArg> & InputErrors
    ): {} extends InputErrors
      ? GetCoWorkGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__CoWorkClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
    ...
    BranchToRoom<T extends CoWork$BranchToRoomArgs = {}>(
      args?: Subset<T, CoWork$BranchToRoomArgs>
    ): Prisma.PrismaPromise<Array<BranchToRoomGetPayload<T>> | Null>;

    FacilityToCoWork<T extends CoWork$FacilityToCoWorkArgs = {}>(
      args?: Subset<T, CoWork$FacilityToCoWorkArgs>
    ): Prisma.PrismaPromise<Array<FacilityToCoWorkGetPayload<T>> | Null>;

    userInternal<T extends UserInternalArgs = {}>(
      args?: Subset<T, UserInternalArgs>
    ): Prisma__UserInternalClient<UserInternalGetPayload<T> | Null>;

    bookRoom<T extends CoWork$bookRoomArgs = {}>(
      args?: Subset<T, CoWork$bookRoomArgs>
    ): Prisma.PrismaPromise<Array<BookRoomGetPayload<T>> | Null>;

    Close<T extends CloseArgs = {}>(
      args?: Subset<T, CloseArgs>
    ): Prisma__CloseClient<CloseGetPayload<T> | Null>;

    Open<T extends OpenArgs = {}>(
      args?: Subset<T, OpenArgs>
    ): Prisma__OpenClient<OpenGetPayload<T> | Null>;

    OpenClose24Hours<T extends OpenClose24HoursArgs = {}>(
      args?: Subset<T, OpenClose24HoursArgs>
    ): Prisma__OpenClose24HoursClient<OpenClose24HoursGetPayload<T> | Null>;

    OpenCloseBoolean<T extends OpenCloseBooleanArgs = {}>(
      args?: Subset<T, OpenCloseBooleanArgs>
    ): Prisma__OpenCloseBooleanClient<OpenCloseBooleanGetPayload<T> | Null>;
  ...
  export type GetUserInternalAggregateType<
    T extends UserInternalAggregateArgs
  > = {
  ...
  type GetUserInternalGroupByPayload<T extends UserInternalGroupByArgs> =
    Prisma.PrismaPromise<
      Array<
        PickArray<UserInternalGroupByOutputType, T["by"]> & {
          [P in keyof T &
            keyof UserInternalGroupByOutputType]: P extends "_count"
            ? T[P] extends boolean
              ? number
  ...
  export type UserInternalGetPayload<
    S extends boolean | null | undefined | UserInternalArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? UserInternal
    ...
    ? UserInternal & {
        [P in TruthyKeys<S["include"]>]: P extends "coWork"
          ? CoWorkGetPayload<S["include"][P]> | null
          : never;
      }
    : S extends { select: any } & (UserInternalArgs | UserInternalFindManyArgs)
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "coWork"
          ? CoWorkGetPayload<S["select"][P]> | null
          : P extends keyof UserInternal
          ? UserInternal[P]
          : never;
      }
    : UserInternal;

  type UserInternalCountArgs = Omit<
    UserInternalFindManyArgs,
    "select" | "include"
  > & {
    select?: UserInternalCountAggregateInputType | true;
  };

  export interface UserInternalDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends UserInternalFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    > extends True
      ...
      : Prisma__UserInternalClient<UserInternalGetPayload<T> | null, null>;
     ...
     **/
    findFirst<
      T extends UserInternalFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
     ...
     * })
     **/
    aggregate<T extends UserInternalAggregateArgs>(
      args: Subset<T, UserInternalAggregateArgs>
    ): Prisma.PrismaPromise<GetUserInternalAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, UserInternalGroupByArgs, OrderByArg> &
        InputErrors
    ): {} extends InputErrors
      ? GetUserInternalGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__UserInternalClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
    ...
    coWork<T extends CoWorkArgs = {}>(
      args?: Subset<T, CoWorkArgs>
    ): Prisma__CoWorkClient<CoWorkGetPayload<T> | Null>;
   ...
   */
  export interface UserInternalFindUniqueArgs
    extends UserInternalFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface UserInternalFindFirstArgs
    extends UserInternalFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type UserInternalUpdateManyArgs = {
     ...
     */
    data: XOR<
      UserInternalUpdateManyMutationInput,
      UserInternalUncheckedUpdateManyInput
    >;
    /**
    ...
    S extends { select: any; include: any }
      ...
      ? Room & {
          [P in TruthyKeys<S["include"]>]: P extends "BranchToRoom"
            ? Array<BranchToRoomGetPayload<S["include"][P]>>
            : P extends "RoomRate"
            ? Array<RoomRateGetPayload<S["include"][P]>>
            : P extends "_count"
            ? RoomCountOutputTypeGetPayload<S["include"][P]>
            : never;
        }
      ...
      ? {
          [P in TruthyKeys<S["select"]>]: P extends "BranchToRoom"
            ? Array<BranchToRoomGetPayload<S["select"][P]>>
            : P extends "RoomRate"
            ? Array<RoomRateGetPayload<S["select"][P]>>
            : P extends "_count"
            ? RoomCountOutputTypeGetPayload<S["select"][P]>
            : P extends keyof Room
            ? Room[P]
            : never;
        }
      : Room;

  type RoomCountArgs = Omit<RoomFindManyArgs, "select" | "include"> & {
  ...
  > {
    ...
    > extends True
      ...
      : Prisma__RoomClient<RoomGetPayload<T> | null, null>;
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__RoomClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
    ...
    BranchToRoom<T extends Room$BranchToRoomArgs = {}>(
      args?: Subset<T, Room$BranchToRoomArgs>
    ): Prisma.PrismaPromise<Array<BranchToRoomGetPayload<T>> | Null>;

    RoomRate<T extends Room$RoomRateArgs = {}>(
      args?: Subset<T, Room$RoomRateArgs>
    ): Prisma.PrismaPromise<Array<RoomRateGetPayload<T>> | Null>;
  ...
  type GetRoomRateGroupByPayload<T extends RoomRateGroupByArgs> =
    Prisma.PrismaPromise<
      Array<
  ...
  export type RoomRateGetPayload<
    S extends boolean | null | undefined | RoomRateArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? RoomRate
    ...
    ? RoomRate & {
        [P in TruthyKeys<S["include"]>]: P extends "BookRoom"
          ? Array<BookRoomGetPayload<S["include"][P]>>
          : P extends "duration"
          ? durationCategoryGetPayload<S["include"][P]>
          : P extends "room"
          ? RoomGetPayload<S["include"][P]> | null
          : P extends "_count"
          ? RoomRateCountOutputTypeGetPayload<S["include"][P]>
          : never;
      }
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "BookRoom"
          ? Array<BookRoomGetPayload<S["select"][P]>>
          : P extends "duration"
          ? durationCategoryGetPayload<S["select"][P]>
          : P extends "room"
          ? RoomGetPayload<S["select"][P]> | null
          : P extends "_count"
          ? RoomRateCountOutputTypeGetPayload<S["select"][P]>
          : P extends keyof RoomRate
          ? RoomRate[P]
          : never;
      }
    : RoomRate;

  type RoomRateCountArgs = Omit<RoomRateFindManyArgs, "select" | "include"> & {
    select?: RoomRateCountAggregateInputType | true;
  };

  export interface RoomRateDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends RoomRateFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    > extends True
      ...
      : Prisma__RoomRateClient<RoomRateGetPayload<T> | null, null>;
     ...
     **/
    findFirst<
      T extends RoomRateFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
     ...
     * })
     **/
    aggregate<T extends RoomRateAggregateArgs>(
      args: Subset<T, RoomRateAggregateArgs>
    ): Prisma.PrismaPromise<GetRoomRateAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, RoomRateGroupByArgs, OrderByArg> & InputErrors
    ): {} extends InputErrors
      ? GetRoomRateGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__RoomRateClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
    ...
    BookRoom<T extends RoomRate$BookRoomArgs = {}>(
      args?: Subset<T, RoomRate$BookRoomArgs>
    ): Prisma.PrismaPromise<Array<BookRoomGetPayload<T>> | Null>;

    duration<T extends durationCategoryArgs = {}>(
      args?: Subset<T, durationCategoryArgs>
    ): Prisma__durationCategoryClient<durationCategoryGetPayload<T> | Null>;

    room<T extends RoomArgs = {}>(
      args?: Subset<T, RoomArgs>
    ): Prisma__RoomClient<RoomGetPayload<T> | Null>;
  ...
  export type RoomRateUpdateManyArgs = {
     ...
     */
    data: XOR<
      RoomRateUpdateManyMutationInput,
      RoomRateUncheckedUpdateManyInput
    >;
    /**
  ...
  export type GetDurationCategoryAggregateType<
    T extends DurationCategoryAggregateArgs
  > = {
    [P in keyof T & keyof AggregateDurationCategory]: P extends
      | "_count"
      | "count"
      ? T[P] extends true
        ? number
  ...
  type GetDurationCategoryGroupByPayload<
    T extends DurationCategoryGroupByArgs
  > = Prisma.PrismaPromise<
    Array<
      PickArray<DurationCategoryGroupByOutputType, T["by"]> & {
        [P in keyof T &
          keyof DurationCategoryGroupByOutputType]: P extends "_count"
          ? T[P] extends boolean
            ? number
  ...
  export type durationCategoryGetPayload<
    S extends boolean | null | undefined | durationCategoryArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? durationCategory
    ...
    : S extends { include: any } & (
        | durationCategoryArgs
        | durationCategoryFindManyArgs
      )
    ? durationCategory & {
        [P in TruthyKeys<S["include"]>]: P extends "RoomRate"
          ? Array<RoomRateGetPayload<S["include"][P]>>
          : P extends "_count"
          ? DurationCategoryCountOutputTypeGetPayload<S["include"][P]>
          : never;
      }
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "RoomRate"
          ? Array<RoomRateGetPayload<S["select"][P]>>
          : P extends "_count"
          ? DurationCategoryCountOutputTypeGetPayload<S["select"][P]>
          : P extends keyof durationCategory
          ? durationCategory[P]
          : never;
      }
    : durationCategory;

  type durationCategoryCountArgs = Omit<
    durationCategoryFindManyArgs,
    "select" | "include"
  > & {
  ...
  export interface durationCategoryDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends durationCategoryFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    > extends True
      ...
      : Prisma__durationCategoryClient<
          durationCategoryGetPayload<T> | null,
          null
        >;
     ...
     **/
    findFirst<
      T extends durationCategoryFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
     ...
     * })
     **/
    aggregate<T extends DurationCategoryAggregateArgs>(
      args: Subset<T, DurationCategoryAggregateArgs>
    ): Prisma.PrismaPromise<GetDurationCategoryAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, DurationCategoryGroupByArgs, OrderByArg> &
        InputErrors
    ): {} extends InputErrors
      ? GetDurationCategoryGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__durationCategoryClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
    ...
    RoomRate<T extends durationCategory$RoomRateArgs = {}>(
      args?: Subset<T, durationCategory$RoomRateArgs>
    ): Prisma.PrismaPromise<Array<RoomRateGetPayload<T>> | Null>;
   ...
   */
  export interface durationCategoryFindUniqueArgs
    extends durationCategoryFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface durationCategoryFindFirstArgs
    extends durationCategoryFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type durationCategoryCreateArgs = {
     ...
     */
    data: XOR<
      durationCategoryCreateInput,
      durationCategoryUncheckedCreateInput
    >;
  };
  ...
  export type durationCategoryUpdateArgs = {
     ...
     */
    data: XOR<
      durationCategoryUpdateInput,
      durationCategoryUncheckedUpdateInput
    >;
    /**
  ...
  export type durationCategoryUpdateManyArgs = {
     ...
     */
    data: XOR<
      durationCategoryUpdateManyMutationInput,
      durationCategoryUncheckedUpdateManyInput
    >;
    /**
  ...
  > = S extends { select: any; include: any }
    ...
    ? Facility & {
        [P in TruthyKeys<S["include"]>]: P extends "FacilityToCoWork"
          ? Array<FacilityToCoWorkGetPayload<S["include"][P]>>
          : P extends "_count"
          ? FacilityCountOutputTypeGetPayload<S["include"][P]>
          : never;
      }
    : S extends { select: any } & (FacilityArgs | FacilityFindManyArgs)
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "FacilityToCoWork"
          ? Array<FacilityToCoWorkGetPayload<S["select"][P]>>
          : P extends "_count"
          ? FacilityCountOutputTypeGetPayload<S["select"][P]>
          : P extends keyof Facility
          ? Facility[P]
          : never;
      }
    : Facility;

  type FacilityCountArgs = Omit<FacilityFindManyArgs, "select" | "include"> & {
  ...
  > {
     ...
     **/
    findUnique<
      T extends FacilityFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    > extends True
      ...
      : Prisma__FacilityClient<FacilityGetPayload<T> | null, null>;
     ...
     **/
    findFirst<
      T extends FacilityFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__FacilityClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
    ...
    FacilityToCoWork<T extends Facility$FacilityToCoWorkArgs = {}>(
      args?: Subset<T, Facility$FacilityToCoWorkArgs>
    ): Prisma.PrismaPromise<Array<FacilityToCoWorkGetPayload<T>> | Null>;
  ...
  export type GetFacilityToCoWorkAggregateType<
    T extends FacilityToCoWorkAggregateArgs
  > = {
    [P in keyof T & keyof AggregateFacilityToCoWork]: P extends
      | "_count"
      | "count"
      ? T[P] extends true
        ? number
  ...
  type GetFacilityToCoWorkGroupByPayload<
    T extends FacilityToCoWorkGroupByArgs
  > = Prisma.PrismaPromise<
    Array<
      PickArray<FacilityToCoWorkGroupByOutputType, T["by"]> & {
        [P in keyof T &
          keyof FacilityToCoWorkGroupByOutputType]: P extends "_count"
          ? T[P] extends boolean
            ? number
  ...
  export type FacilityToCoWorkGetPayload<
    S extends boolean | null | undefined | FacilityToCoWorkArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? FacilityToCoWork
    ...
    ? never
    : S extends { include: any } & (
        | FacilityToCoWorkArgs
        | FacilityToCoWorkFindManyArgs
      )
    ? FacilityToCoWork & {
        [P in TruthyKeys<S["include"]>]: P extends "coWork"
          ? CoWorkGetPayload<S["include"][P]>
          : P extends "facility"
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "coWork"
          ? CoWorkGetPayload<S["select"][P]>
          : P extends "facility"
          ? FacilityGetPayload<S["select"][P]>
          : P extends keyof FacilityToCoWork
          ? FacilityToCoWork[P]
          : never;
      }
    : FacilityToCoWork;

  type FacilityToCoWorkCountArgs = Omit<
    FacilityToCoWorkFindManyArgs,
    "select" | "include"
  > & {
  ...
  export interface FacilityToCoWorkDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends FacilityToCoWorkFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    > extends True
      ...
      : Prisma__FacilityToCoWorkClient<
          FacilityToCoWorkGetPayload<T> | null,
          null
        >;
     ...
     **/
    findFirst<
      T extends FacilityToCoWorkFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
     ...
     * })
     **/
    aggregate<T extends FacilityToCoWorkAggregateArgs>(
      args: Subset<T, FacilityToCoWorkAggregateArgs>
    ): Prisma.PrismaPromise<GetFacilityToCoWorkAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, FacilityToCoWorkGroupByArgs, OrderByArg> &
        InputErrors
    ): {} extends InputErrors
      ? GetFacilityToCoWorkGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__FacilityToCoWorkClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
    ...
    facility<T extends FacilityArgs = {}>(
      args?: Subset<T, FacilityArgs>
    ): Prisma__FacilityClient<FacilityGetPayload<T> | Null>;
   ...
   */
  export interface FacilityToCoWorkFindUniqueArgs
    extends FacilityToCoWorkFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface FacilityToCoWorkFindFirstArgs
    extends FacilityToCoWorkFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type FacilityToCoWorkCreateArgs = {
     ...
     */
    data: XOR<
      FacilityToCoWorkCreateInput,
      FacilityToCoWorkUncheckedCreateInput
    >;
  };
  ...
  export type FacilityToCoWorkUpdateArgs = {
     ...
     */
    data: XOR<
      FacilityToCoWorkUpdateInput,
      FacilityToCoWorkUncheckedUpdateInput
    >;
    /**
  ...
  export type FacilityToCoWorkUpdateManyArgs = {
     ...
     */
    data: XOR<
      FacilityToCoWorkUpdateManyMutationInput,
      FacilityToCoWorkUncheckedUpdateManyInput
    >;
    /**
  ...
  export type GetBranchToRoomAggregateType<
    T extends BranchToRoomAggregateArgs
  > = {
  ...
  type GetBranchToRoomGroupByPayload<T extends BranchToRoomGroupByArgs> =
    Prisma.PrismaPromise<
      Array<
        PickArray<BranchToRoomGroupByOutputType, T["by"]> & {
          [P in keyof T &
            keyof BranchToRoomGroupByOutputType]: P extends "_count"
            ? T[P] extends boolean
              ? number
  ...
  export type BranchToRoomGetPayload<
    S extends boolean | null | undefined | BranchToRoomArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? BranchToRoom
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "coWork"
          ...
          : P extends keyof BranchToRoom
          ? BranchToRoom[P]
          : never;
      }
    : BranchToRoom;

  type BranchToRoomCountArgs = Omit<
    BranchToRoomFindManyArgs,
    "select" | "include"
  > & {
    select?: BranchToRoomCountAggregateInputType | true;
  };

  export interface BranchToRoomDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends BranchToRoomFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    > extends True
      ...
      : Prisma__BranchToRoomClient<BranchToRoomGetPayload<T> | null, null>;
     ...
     **/
    findFirst<
      T extends BranchToRoomFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
     ...
     * })
     **/
    aggregate<T extends BranchToRoomAggregateArgs>(
      args: Subset<T, BranchToRoomAggregateArgs>
    ): Prisma.PrismaPromise<GetBranchToRoomAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, BranchToRoomGroupByArgs, OrderByArg> &
        InputErrors
    ): {} extends InputErrors
      ? GetBranchToRoomGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__BranchToRoomClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
   ...
   */
  export interface BranchToRoomFindUniqueArgs
    extends BranchToRoomFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface BranchToRoomFindFirstArgs
    extends BranchToRoomFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type BranchToRoomUpdateManyArgs = {
     ...
     */
    data: XOR<
      BranchToRoomUpdateManyMutationInput,
      BranchToRoomUncheckedUpdateManyInput
    >;
    /**
  ...
  type GetBookRoomGroupByPayload<T extends BookRoomGroupByArgs> =
    Prisma.PrismaPromise<
      Array<
  ...
  export type BookRoomGetPayload<
    S extends boolean | null | undefined | BookRoomArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? BookRoom
    ...
    ? BookRoom & {
        [P in TruthyKeys<S["include"]>]: P extends "cowork"
          ? CoWorkGetPayload<S["include"][P]>
          : P extends "roomRate"
          ? RoomRateGetPayload<S["include"][P]>
          : P extends "UserExternal"
          ? UserExternalGetPayload<S["include"][P]>
          : P extends "vertifyCode"
          ? VertifyBookingCodeGetPayload<S["include"][P]>
          : never;
      }
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "cowork"
          ? CoWorkGetPayload<S["select"][P]>
          : P extends "roomRate"
          ? RoomRateGetPayload<S["select"][P]>
          : P extends "UserExternal"
          ? UserExternalGetPayload<S["select"][P]>
          : P extends "vertifyCode"
          ? VertifyBookingCodeGetPayload<S["select"][P]>
          : P extends keyof BookRoom
          ? BookRoom[P]
          : never;
      }
    : BookRoom;

  type BookRoomCountArgs = Omit<BookRoomFindManyArgs, "select" | "include"> & {
    select?: BookRoomCountAggregateInputType | true;
  };

  export interface BookRoomDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends BookRoomFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    > extends True
      ...
      : Prisma__BookRoomClient<BookRoomGetPayload<T> | null, null>;
     ...
     **/
    findFirst<
      T extends BookRoomFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
     ...
     * })
     **/
    aggregate<T extends BookRoomAggregateArgs>(
      args: Subset<T, BookRoomAggregateArgs>
    ): Prisma.PrismaPromise<GetBookRoomAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, BookRoomGroupByArgs, OrderByArg> & InputErrors
    ): {} extends InputErrors
      ? GetBookRoomGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__BookRoomClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
    ...
    roomRate<T extends RoomRateArgs = {}>(
      args?: Subset<T, RoomRateArgs>
    ): Prisma__RoomRateClient<RoomRateGetPayload<T> | Null>;

    UserExternal<T extends UserExternalArgs = {}>(
      args?: Subset<T, UserExternalArgs>
    ): Prisma__UserExternalClient<UserExternalGetPayload<T> | Null>;

    vertifyCode<T extends VertifyBookingCodeArgs = {}>(
      args?: Subset<T, VertifyBookingCodeArgs>
    ): Prisma__VertifyBookingCodeClient<VertifyBookingCodeGetPayload<T> | Null>;
  ...
  export type BookRoomUpdateManyArgs = {
     ...
     */
    data: XOR<
      BookRoomUpdateManyMutationInput,
      BookRoomUncheckedUpdateManyInput
    >;
    /**
  ...
  export type GetVertifyBookingCodeAggregateType<
    T extends VertifyBookingCodeAggregateArgs
  > = {
    [P in keyof T & keyof AggregateVertifyBookingCode]: P extends
      | "_count"
      | "count"
      ? T[P] extends true
        ? number
  ...
  type GetVertifyBookingCodeGroupByPayload<
    T extends VertifyBookingCodeGroupByArgs
  > = Prisma.PrismaPromise<
    Array<
      PickArray<VertifyBookingCodeGroupByOutputType, T["by"]> & {
        [P in keyof T &
          keyof VertifyBookingCodeGroupByOutputType]: P extends "_count"
          ? T[P] extends boolean
            ? number
  ...
  export type VertifyBookingCodeGetPayload<
    S extends boolean | null | undefined | VertifyBookingCodeArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? VertifyBookingCode
    ...
    ? never
    : S extends { include: any } & (
        | VertifyBookingCodeArgs
        | VertifyBookingCodeFindManyArgs
      )
    ? VertifyBookingCode & {
        [P in TruthyKeys<S["include"]>]: P extends "bookRoom"
          ? Array<BookRoomGetPayload<S["include"][P]>>
          : P extends "_count"
          ? VertifyBookingCodeCountOutputTypeGetPayload<S["include"][P]>
          : never;
      }
    : S extends { select: any } & (
        | VertifyBookingCodeArgs
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "bookRoom"
          ? Array<BookRoomGetPayload<S["select"][P]>>
          : P extends "_count"
          ? VertifyBookingCodeCountOutputTypeGetPayload<S["select"][P]>
          : P extends keyof VertifyBookingCode
          ? VertifyBookingCode[P]
          : never;
      }
    : VertifyBookingCode;

  type VertifyBookingCodeCountArgs = Omit<
    VertifyBookingCodeFindManyArgs,
    "select" | "include"
  > & {
  ...
  export interface VertifyBookingCodeDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends VertifyBookingCodeFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    > extends True
      ...
      : Prisma__VertifyBookingCodeClient<
          VertifyBookingCodeGetPayload<T> | null,
          null
        >;
     ...
     **/
    findFirst<
      T extends VertifyBookingCodeFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    count<T extends VertifyBookingCodeCountArgs>(
      ...
      T extends _Record<"select", any>
        ? T["select"] extends true
          ...
          : GetScalarType<
              T["select"],
              VertifyBookingCodeCountAggregateOutputType
            >
        : number
    >;
     ...
     * })
     **/
    aggregate<T extends VertifyBookingCodeAggregateArgs>(
      args: Subset<T, VertifyBookingCodeAggregateArgs>
    ): Prisma.PrismaPromise<GetVertifyBookingCodeAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, VertifyBookingCodeGroupByArgs, OrderByArg> &
        InputErrors
    ): {} extends InputErrors
      ? GetVertifyBookingCodeGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__VertifyBookingCodeClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
    ...
    bookRoom<T extends VertifyBookingCode$bookRoomArgs = {}>(
      args?: Subset<T, VertifyBookingCode$bookRoomArgs>
    ): Prisma.PrismaPromise<Array<BookRoomGetPayload<T>> | Null>;
   ...
   */
  export interface VertifyBookingCodeFindUniqueArgs
    extends VertifyBookingCodeFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface VertifyBookingCodeFindFirstArgs
    extends VertifyBookingCodeFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type VertifyBookingCodeCreateArgs = {
     ...
     */
    data: XOR<
      VertifyBookingCodeCreateInput,
      VertifyBookingCodeUncheckedCreateInput
    >;
  };
  ...
  export type VertifyBookingCodeUpdateArgs = {
     ...
     */
    data: XOR<
      VertifyBookingCodeUpdateInput,
      VertifyBookingCodeUncheckedUpdateInput
    >;
    /**
  ...
  export type VertifyBookingCodeUpdateManyArgs = {
     ...
     */
    data: XOR<
      VertifyBookingCodeUpdateManyMutationInput,
      VertifyBookingCodeUncheckedUpdateManyInput
    >;
    /**
  ...
  export type OpenGetPayload<S extends boolean | null | undefined | OpenArgs> =
    S extends { select: any; include: any }
      ...
      ? {
          [P in TruthyKeys<S["select"]>]: P extends "cowork"
            ? CoWorkGetPayload<S["select"][P]>
            : P extends keyof Open
            ? Open[P]
            : never;
        }
      : Open;

  type OpenCountArgs = Omit<OpenFindManyArgs, "select" | "include"> & {
  ...
  > {
    ...
    > extends True
      ...
      : Prisma__OpenClient<OpenGetPayload<T> | null, null>;
     ...
     * })
     **/
    aggregate<T extends OpenAggregateArgs>(
      args: Subset<T, OpenAggregateArgs>
    ): Prisma.PrismaPromise<GetOpenAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, OpenGroupByArgs, OrderByArg> & InputErrors
    ): {} extends InputErrors
      ? GetOpenGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__OpenClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
  ...
  type GetCloseGroupByPayload<T extends CloseGroupByArgs> =
    Prisma.PrismaPromise<
      Array<
  ...
  export type CloseGetPayload<
    S extends boolean | null | undefined | CloseArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? Close
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "cowork"
          ? CoWorkGetPayload<S["select"][P]>
          : P extends keyof Close
          ? Close[P]
          : never;
      }
    : Close;

  type CloseCountArgs = Omit<CloseFindManyArgs, "select" | "include"> & {
  ...
  > {
    ...
    > extends True
      ...
      : Prisma__CloseClient<CloseGetPayload<T> | null, null>;
     ...
     * })
     **/
    aggregate<T extends CloseAggregateArgs>(
      args: Subset<T, CloseAggregateArgs>
    ): Prisma.PrismaPromise<GetCloseAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, CloseGroupByArgs, OrderByArg> & InputErrors
    ): {} extends InputErrors
      ? GetCloseGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__CloseClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
  ...
  export type GetOpenClose24HoursAggregateType<
    T extends OpenClose24HoursAggregateArgs
  > = {
    [P in keyof T & keyof AggregateOpenClose24Hours]: P extends
      | "_count"
      | "count"
      ? T[P] extends true
        ? number
  ...
  type GetOpenClose24HoursGroupByPayload<
    T extends OpenClose24HoursGroupByArgs
  > = Prisma.PrismaPromise<
    Array<
      PickArray<OpenClose24HoursGroupByOutputType, T["by"]> & {
        [P in keyof T &
          keyof OpenClose24HoursGroupByOutputType]: P extends "_count"
          ? T[P] extends boolean
            ? number
  ...
  export type OpenClose24HoursGetPayload<
    S extends boolean | null | undefined | OpenClose24HoursArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? OpenClose24Hours
    ...
    ? never
    : S extends { include: any } & (
        | OpenClose24HoursArgs
        | OpenClose24HoursFindManyArgs
      )
    ? OpenClose24Hours & {
        [P in TruthyKeys<S["include"]>]: P extends "cowork"
          ? CoWorkGetPayload<S["include"][P]>
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "cowork"
          ? CoWorkGetPayload<S["select"][P]>
          : P extends keyof OpenClose24Hours
          ? OpenClose24Hours[P]
          : never;
      }
    : OpenClose24Hours;

  type OpenClose24HoursCountArgs = Omit<
    OpenClose24HoursFindManyArgs,
    "select" | "include"
  > & {
  ...
  export interface OpenClose24HoursDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends OpenClose24HoursFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    > extends True
      ...
      : Prisma__OpenClose24HoursClient<
          OpenClose24HoursGetPayload<T> | null,
          null
        >;
     ...
     **/
    findFirst<
      T extends OpenClose24HoursFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
     ...
     * })
     **/
    aggregate<T extends OpenClose24HoursAggregateArgs>(
      args: Subset<T, OpenClose24HoursAggregateArgs>
    ): Prisma.PrismaPromise<GetOpenClose24HoursAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, OpenClose24HoursGroupByArgs, OrderByArg> &
        InputErrors
    ): {} extends InputErrors
      ? GetOpenClose24HoursGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__OpenClose24HoursClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
   ...
   */
  export interface OpenClose24HoursFindUniqueArgs
    extends OpenClose24HoursFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface OpenClose24HoursFindFirstArgs
    extends OpenClose24HoursFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type OpenClose24HoursCreateArgs = {
     ...
     */
    data: XOR<
      OpenClose24HoursCreateInput,
      OpenClose24HoursUncheckedCreateInput
    >;
  };
  ...
  export type OpenClose24HoursUpdateArgs = {
     ...
     */
    data: XOR<
      OpenClose24HoursUpdateInput,
      OpenClose24HoursUncheckedUpdateInput
    >;
    /**
  ...
  export type OpenClose24HoursUpdateManyArgs = {
     ...
     */
    data: XOR<
      OpenClose24HoursUpdateManyMutationInput,
      OpenClose24HoursUncheckedUpdateManyInput
    >;
    /**
  ...
  export type GetOpenCloseBooleanAggregateType<
    T extends OpenCloseBooleanAggregateArgs
  > = {
    [P in keyof T & keyof AggregateOpenCloseBoolean]: P extends
      | "_count"
      | "count"
      ? T[P] extends true
        ? number
  ...
  type GetOpenCloseBooleanGroupByPayload<
    T extends OpenCloseBooleanGroupByArgs
  > = Prisma.PrismaPromise<
    Array<
      PickArray<OpenCloseBooleanGroupByOutputType, T["by"]> & {
        [P in keyof T &
          keyof OpenCloseBooleanGroupByOutputType]: P extends "_count"
          ? T[P] extends boolean
            ? number
  ...
  export type OpenCloseBooleanGetPayload<
    S extends boolean | null | undefined | OpenCloseBooleanArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? OpenCloseBoolean
    ...
    ? never
    : S extends { include: any } & (
        | OpenCloseBooleanArgs
        | OpenCloseBooleanFindManyArgs
      )
    ? OpenCloseBoolean & {
        [P in TruthyKeys<S["include"]>]: P extends "cowork"
          ? CoWorkGetPayload<S["include"][P]>
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "cowork"
          ? CoWorkGetPayload<S["select"][P]>
          : P extends keyof OpenCloseBoolean
          ? OpenCloseBoolean[P]
          : never;
      }
    : OpenCloseBoolean;

  type OpenCloseBooleanCountArgs = Omit<
    OpenCloseBooleanFindManyArgs,
    "select" | "include"
  > & {
  ...
  export interface OpenCloseBooleanDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends OpenCloseBooleanFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    > extends True
      ...
      : Prisma__OpenCloseBooleanClient<
          OpenCloseBooleanGetPayload<T> | null,
          null
        >;
     ...
     **/
    findFirst<
      T extends OpenCloseBooleanFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
     ...
     * })
     **/
    aggregate<T extends OpenCloseBooleanAggregateArgs>(
      args: Subset<T, OpenCloseBooleanAggregateArgs>
    ): Prisma.PrismaPromise<GetOpenCloseBooleanAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, OpenCloseBooleanGroupByArgs, OrderByArg> &
        InputErrors
    ): {} extends InputErrors
      ? GetOpenCloseBooleanGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__OpenCloseBooleanClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
   ...
   */
  export interface OpenCloseBooleanFindUniqueArgs
    extends OpenCloseBooleanFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface OpenCloseBooleanFindFirstArgs
    extends OpenCloseBooleanFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type OpenCloseBooleanCreateArgs = {
     ...
     */
    data: XOR<
      OpenCloseBooleanCreateInput,
      OpenCloseBooleanUncheckedCreateInput
    >;
  };
  ...
  export type OpenCloseBooleanUpdateArgs = {
     ...
     */
    data: XOR<
      OpenCloseBooleanUpdateInput,
      OpenCloseBooleanUncheckedUpdateInput
    >;
    /**
  ...
  export type OpenCloseBooleanUpdateManyArgs = {
     ...
     */
    data: XOR<
      OpenCloseBooleanUpdateManyMutationInput,
      OpenCloseBooleanUncheckedUpdateManyInput
    >;
    /**
  ...
  export type BookRoomScalarFieldEnum =
    typeof BookRoomScalarFieldEnum[keyof typeof BookRoomScalarFieldEnum];
  ...
  export type BranchToRoomScalarFieldEnum =
    typeof BranchToRoomScalarFieldEnum[keyof typeof BranchToRoomScalarFieldEnum];
  ...
  export type CloseScalarFieldEnum =
    typeof CloseScalarFieldEnum[keyof typeof CloseScalarFieldEnum];
  ...
  export type CoWorkScalarFieldEnum =
    typeof CoWorkScalarFieldEnum[keyof typeof CoWorkScalarFieldEnum];
  ...
  export type DurationCategoryScalarFieldEnum =
    typeof DurationCategoryScalarFieldEnum[keyof typeof DurationCategoryScalarFieldEnum];
  ...
  export type FacilityToCoWorkScalarFieldEnum =
    typeof FacilityToCoWorkScalarFieldEnum[keyof typeof FacilityToCoWorkScalarFieldEnum];
  ...
  export type OpenClose24HoursScalarFieldEnum =
    typeof OpenClose24HoursScalarFieldEnum[keyof typeof OpenClose24HoursScalarFieldEnum];
  ...
  export type OpenCloseBooleanScalarFieldEnum =
    typeof OpenCloseBooleanScalarFieldEnum[keyof typeof OpenCloseBooleanScalarFieldEnum];
  ...
  export type OpenScalarFieldEnum =
    typeof OpenScalarFieldEnum[keyof typeof OpenScalarFieldEnum];
  ...
  export type RoomRateScalarFieldEnum =
    typeof RoomRateScalarFieldEnum[keyof typeof RoomRateScalarFieldEnum];
  ...
  export type UserExternalScalarFieldEnum =
    typeof UserExternalScalarFieldEnum[keyof typeof UserExternalScalarFieldEnum];
  ...
  export type UserInternalScalarFieldEnum =
    typeof UserInternalScalarFieldEnum[keyof typeof UserInternalScalarFieldEnum];
  ...
  export type VertifyBookingCodeScalarFieldEnum =
    typeof VertifyBookingCodeScalarFieldEnum[keyof typeof VertifyBookingCodeScalarFieldEnum];
  ...
  export type CoWorkWhereInput = {
    ...
    userInternal?: XOR<
      UserInternalRelationFilter,
      UserInternalWhereInput
    > | null;
    bookRoom?: BookRoomListRelationFilter;
    Close?: XOR<CloseRelationFilter, CloseWhereInput> | null;
    Open?: XOR<OpenRelationFilter, OpenWhereInput> | null;
    OpenClose24Hours?: XOR<
      OpenClose24HoursRelationFilter,
      OpenClose24HoursWhereInput
    > | null;
    OpenCloseBoolean?: XOR<
      OpenCloseBooleanRelationFilter,
      OpenCloseBooleanWhereInput
    > | null;
  };
  ...
  export type BookRoomWhereInput = {
    ...
    vertifyCode?: XOR<
      VertifyBookingCodeRelationFilter,
      VertifyBookingCodeWhereInput
    >;
  };
  ...
  export type BookRoomCreateNestedManyWithoutUserExternalInput = {
    create?: XOR<
      Enumerable<BookRoomCreateWithoutUserExternalInput>,
      Enumerable<BookRoomUncheckedCreateWithoutUserExternalInput>
    >;
  ...
  export type BranchToRoomCreateNestedManyWithoutCoWorkInput = {
    create?: XOR<
      Enumerable<BranchToRoomCreateWithoutCoWorkInput>,
      Enumerable<BranchToRoomUncheckedCreateWithoutCoWorkInput>
    >;
  ...
  export type FacilityToCoWorkCreateNestedManyWithoutCoWorkInput = {
    create?: XOR<
      Enumerable<FacilityToCoWorkCreateWithoutCoWorkInput>,
      Enumerable<FacilityToCoWorkUncheckedCreateWithoutCoWorkInput>
    >;
  ...
  export type UserInternalCreateNestedOneWithoutCoWorkInput = {
    create?: XOR<
      UserInternalCreateWithoutCoWorkInput,
      UserInternalUncheckedCreateWithoutCoWorkInput
    >;
  ...
  export type BookRoomCreateNestedManyWithoutCoworkInput = {
    create?: XOR<
      Enumerable<BookRoomCreateWithoutCoworkInput>,
      Enumerable<BookRoomUncheckedCreateWithoutCoworkInput>
    >;
  ...
  export type CloseCreateNestedOneWithoutCoworkInput = {
    create?: XOR<
      CloseCreateWithoutCoworkInput,
      CloseUncheckedCreateWithoutCoworkInput
    >;
  ...
  export type OpenCreateNestedOneWithoutCoworkInput = {
    create?: XOR<
      OpenCreateWithoutCoworkInput,
      OpenUncheckedCreateWithoutCoworkInput
    >;
  ...
  export type OpenClose24HoursCreateNestedOneWithoutCoworkInput = {
    create?: XOR<
      OpenClose24HoursCreateWithoutCoworkInput,
      OpenClose24HoursUncheckedCreateWithoutCoworkInput
    >;
  ...
  export type OpenCloseBooleanCreateNestedOneWithoutCoworkInput = {
    create?: XOR<
      OpenCloseBooleanCreateWithoutCoworkInput,
      OpenCloseBooleanUncheckedCreateWithoutCoworkInput
    >;
  ...
  export type UserInternalUpdateOneWithoutCoWorkNestedInput = {
    ...
    connect?: UserInternalWhereUniqueInput;
    update?: XOR<
      UserInternalUpdateWithoutCoWorkInput,
      UserInternalUncheckedUpdateWithoutCoWorkInput
    >;
  };
  ...
  export type CloseUpdateOneWithoutCoworkNestedInput = {
    ...
    connect?: CloseWhereUniqueInput;
    update?: XOR<
      CloseUpdateWithoutCoworkInput,
      CloseUncheckedUpdateWithoutCoworkInput
    >;
  };
  ...
  export type OpenUpdateOneWithoutCoworkNestedInput = {
    ...
    connect?: OpenWhereUniqueInput;
    update?: XOR<
      OpenUpdateWithoutCoworkInput,
      OpenUncheckedUpdateWithoutCoworkInput
    >;
  };
  ...
  export type OpenClose24HoursUpdateOneWithoutCoworkNestedInput = {
    ...
    connect?: OpenClose24HoursWhereUniqueInput;
    update?: XOR<
      OpenClose24HoursUpdateWithoutCoworkInput,
      OpenClose24HoursUncheckedUpdateWithoutCoworkInput
    >;
  };
  ...
  export type OpenCloseBooleanUpdateOneWithoutCoworkNestedInput = {
    ...
    connect?: OpenCloseBooleanWhereUniqueInput;
    update?: XOR<
      OpenCloseBooleanUpdateWithoutCoworkInput,
      OpenCloseBooleanUncheckedUpdateWithoutCoworkInput
    >;
  };
  ...
  export type CoWorkCreateNestedOneWithoutUserInternalInput = {
    create?: XOR<
      CoWorkCreateWithoutUserInternalInput,
      CoWorkUncheckedCreateWithoutUserInternalInput
    >;
  ...
  export type CoWorkUpdateOneWithoutUserInternalNestedInput = {
    ...
    connect?: CoWorkWhereUniqueInput;
    update?: XOR<
      CoWorkUpdateWithoutUserInternalInput,
      CoWorkUncheckedUpdateWithoutUserInternalInput
    >;
  };
  ...
  export type BranchToRoomCreateNestedManyWithoutRoomInput = {
    create?: XOR<
      Enumerable<BranchToRoomCreateWithoutRoomInput>,
      Enumerable<BranchToRoomUncheckedCreateWithoutRoomInput>
    >;
  ...
  export type RoomRateCreateNestedManyWithoutRoomInput = {
    create?: XOR<
      Enumerable<RoomRateCreateWithoutRoomInput>,
      Enumerable<RoomRateUncheckedCreateWithoutRoomInput>
    >;
  ...
  export type BookRoomCreateNestedManyWithoutRoomRateInput = {
    create?: XOR<
      Enumerable<BookRoomCreateWithoutRoomRateInput>,
      Enumerable<BookRoomUncheckedCreateWithoutRoomRateInput>
    >;
  ...
  export type durationCategoryCreateNestedOneWithoutRoomRateInput = {
    create?: XOR<
      durationCategoryCreateWithoutRoomRateInput,
      durationCategoryUncheckedCreateWithoutRoomRateInput
    >;
  ...
  export type RoomCreateNestedOneWithoutRoomRateInput = {
    create?: XOR<
      RoomCreateWithoutRoomRateInput,
      RoomUncheckedCreateWithoutRoomRateInput
    >;
  ...
  export type durationCategoryUpdateOneRequiredWithoutRoomRateNestedInput = {
    ...
    connect?: durationCategoryWhereUniqueInput;
    update?: XOR<
      durationCategoryUpdateWithoutRoomRateInput,
      durationCategoryUncheckedUpdateWithoutRoomRateInput
    >;
  };
  ...
  export type RoomUpdateOneWithoutRoomRateNestedInput = {
    ...
    connect?: RoomWhereUniqueInput;
    update?: XOR<
      RoomUpdateWithoutRoomRateInput,
      RoomUncheckedUpdateWithoutRoomRateInput
    >;
  };
  ...
  export type RoomRateCreateNestedManyWithoutDurationInput = {
    create?: XOR<
      Enumerable<RoomRateCreateWithoutDurationInput>,
      Enumerable<RoomRateUncheckedCreateWithoutDurationInput>
    >;
  ...
  export type FacilityToCoWorkCreateNestedManyWithoutFacilityInput = {
    create?: XOR<
      Enumerable<FacilityToCoWorkCreateWithoutFacilityInput>,
      Enumerable<FacilityToCoWorkUncheckedCreateWithoutFacilityInput>
    >;
  ...
  export type CoWorkCreateNestedOneWithoutFacilityToCoWorkInput = {
    create?: XOR<
      CoWorkCreateWithoutFacilityToCoWorkInput,
      CoWorkUncheckedCreateWithoutFacilityToCoWorkInput
    >;
  ...
  export type FacilityCreateNestedOneWithoutFacilityToCoWorkInput = {
    create?: XOR<
      FacilityCreateWithoutFacilityToCoWorkInput,
      FacilityUncheckedCreateWithoutFacilityToCoWorkInput
    >;
  ...
  export type CoWorkUpdateOneRequiredWithoutFacilityToCoWorkNestedInput = {
    ...
    connect?: CoWorkWhereUniqueInput;
    update?: XOR<
      CoWorkUpdateWithoutFacilityToCoWorkInput,
      CoWorkUncheckedUpdateWithoutFacilityToCoWorkInput
    >;
  };
  ...
  export type FacilityUpdateOneRequiredWithoutFacilityToCoWorkNestedInput = {
    ...
    connect?: FacilityWhereUniqueInput;
    update?: XOR<
      FacilityUpdateWithoutFacilityToCoWorkInput,
      FacilityUncheckedUpdateWithoutFacilityToCoWorkInput
    >;
  };

  export type CoWorkCreateNestedOneWithoutBranchToRoomInput = {
    create?: XOR<
      CoWorkCreateWithoutBranchToRoomInput,
      CoWorkUncheckedCreateWithoutBranchToRoomInput
    >;
  ...
  export type RoomCreateNestedOneWithoutBranchToRoomInput = {
    create?: XOR<
      RoomCreateWithoutBranchToRoomInput,
      RoomUncheckedCreateWithoutBranchToRoomInput
    >;
  ...
  export type CoWorkUpdateOneRequiredWithoutBranchToRoomNestedInput = {
    ...
    connect?: CoWorkWhereUniqueInput;
    update?: XOR<
      CoWorkUpdateWithoutBranchToRoomInput,
      CoWorkUncheckedUpdateWithoutBranchToRoomInput
    >;
  };
  ...
  export type RoomUpdateOneRequiredWithoutBranchToRoomNestedInput = {
    ...
    connect?: RoomWhereUniqueInput;
    update?: XOR<
      RoomUpdateWithoutBranchToRoomInput,
      RoomUncheckedUpdateWithoutBranchToRoomInput
    >;
  };

  export type CoWorkCreateNestedOneWithoutBookRoomInput = {
    create?: XOR<
      CoWorkCreateWithoutBookRoomInput,
      CoWorkUncheckedCreateWithoutBookRoomInput
    >;
  ...
  export type RoomRateCreateNestedOneWithoutBookRoomInput = {
    create?: XOR<
      RoomRateCreateWithoutBookRoomInput,
      RoomRateUncheckedCreateWithoutBookRoomInput
    >;
  ...
  export type UserExternalCreateNestedOneWithoutBookRoomInput = {
    create?: XOR<
      UserExternalCreateWithoutBookRoomInput,
      UserExternalUncheckedCreateWithoutBookRoomInput
    >;
  ...
  export type VertifyBookingCodeCreateNestedOneWithoutBookRoomInput = {
    create?: XOR<
      VertifyBookingCodeCreateWithoutBookRoomInput,
      VertifyBookingCodeUncheckedCreateWithoutBookRoomInput
    >;
  ...
  export type CoWorkUpdateOneRequiredWithoutBookRoomNestedInput = {
    ...
    connect?: CoWorkWhereUniqueInput;
    update?: XOR<
      CoWorkUpdateWithoutBookRoomInput,
      CoWorkUncheckedUpdateWithoutBookRoomInput
    >;
  };
  ...
  export type RoomRateUpdateOneRequiredWithoutBookRoomNestedInput = {
    ...
    connect?: RoomRateWhereUniqueInput;
    update?: XOR<
      RoomRateUpdateWithoutBookRoomInput,
      RoomRateUncheckedUpdateWithoutBookRoomInput
    >;
  };
  ...
  export type UserExternalUpdateOneRequiredWithoutBookRoomNestedInput = {
    ...
    connect?: UserExternalWhereUniqueInput;
    update?: XOR<
      UserExternalUpdateWithoutBookRoomInput,
      UserExternalUncheckedUpdateWithoutBookRoomInput
    >;
  };
  ...
  export type VertifyBookingCodeUpdateOneRequiredWithoutBookRoomNestedInput = {
    ...
    connect?: VertifyBookingCodeWhereUniqueInput;
    update?: XOR<
      VertifyBookingCodeUpdateWithoutBookRoomInput,
      VertifyBookingCodeUncheckedUpdateWithoutBookRoomInput
    >;
  };

  export type BookRoomCreateNestedManyWithoutVertifyCodeInput = {
    create?: XOR<
      Enumerable<BookRoomCreateWithoutVertifyCodeInput>,
      Enumerable<BookRoomUncheckedCreateWithoutVertifyCodeInput>
    >;
  ...
  export type CoWorkCreateNestedOneWithoutOpenInput = {
    create?: XOR<
      CoWorkCreateWithoutOpenInput,
      CoWorkUncheckedCreateWithoutOpenInput
    >;
  ...
  export type CoWorkUpdateOneRequiredWithoutOpenNestedInput = {
    ...
    connect?: CoWorkWhereUniqueInput;
    update?: XOR<
      CoWorkUpdateWithoutOpenInput,
      CoWorkUncheckedUpdateWithoutOpenInput
    >;
  };

  export type CoWorkCreateNestedOneWithoutCloseInput = {
    create?: XOR<
      CoWorkCreateWithoutCloseInput,
      CoWorkUncheckedCreateWithoutCloseInput
    >;
  ...
  export type CoWorkUpdateOneRequiredWithoutCloseNestedInput = {
    ...
    connect?: CoWorkWhereUniqueInput;
    update?: XOR<
      CoWorkUpdateWithoutCloseInput,
      CoWorkUncheckedUpdateWithoutCloseInput
    >;
  };

  export type CoWorkCreateNestedOneWithoutOpenClose24HoursInput = {
    create?: XOR<
      CoWorkCreateWithoutOpenClose24HoursInput,
      CoWorkUncheckedCreateWithoutOpenClose24HoursInput
    >;
  ...
  export type CoWorkUpdateOneRequiredWithoutOpenClose24HoursNestedInput = {
    ...
    connect?: CoWorkWhereUniqueInput;
    update?: XOR<
      CoWorkUpdateWithoutOpenClose24HoursInput,
      CoWorkUncheckedUpdateWithoutOpenClose24HoursInput
    >;
  };

  export type CoWorkCreateNestedOneWithoutOpenCloseBooleanInput = {
    create?: XOR<
      CoWorkCreateWithoutOpenCloseBooleanInput,
      CoWorkUncheckedCreateWithoutOpenCloseBooleanInput
    >;
  ...
  export type CoWorkUpdateOneRequiredWithoutOpenCloseBooleanNestedInput = {
    ...
    connect?: CoWorkWhereUniqueInput;
    update?: XOR<
      CoWorkUpdateWithoutOpenCloseBooleanInput,
      CoWorkUncheckedUpdateWithoutOpenCloseBooleanInput
    >;
  };
  ...
  export type BookRoomCreateOrConnectWithoutUserExternalInput = {
    where: BookRoomWhereUniqueInput;
    create: XOR<
      BookRoomCreateWithoutUserExternalInput,
      BookRoomUncheckedCreateWithoutUserExternalInput
    >;
  };
  ...
  export type BookRoomUpsertWithWhereUniqueWithoutUserExternalInput = {
    where: BookRoomWhereUniqueInput;
    update: XOR<
      BookRoomUpdateWithoutUserExternalInput,
      BookRoomUncheckedUpdateWithoutUserExternalInput
    >;
    create: XOR<
      BookRoomCreateWithoutUserExternalInput,
      BookRoomUncheckedCreateWithoutUserExternalInput
  ...
  export type BookRoomUpdateManyWithWhereWithoutUserExternalInput = {
    ...
    data: XOR<
      BookRoomUpdateManyMutationInput,
      BookRoomUncheckedUpdateManyWithoutBookRoomInput
    >;
  };
  ...
  export type BranchToRoomCreateOrConnectWithoutCoWorkInput = {
    where: BranchToRoomWhereUniqueInput;
    create: XOR<
      BranchToRoomCreateWithoutCoWorkInput,
      BranchToRoomUncheckedCreateWithoutCoWorkInput
    >;
  };
  ...
  export type FacilityToCoWorkCreateOrConnectWithoutCoWorkInput = {
    where: FacilityToCoWorkWhereUniqueInput;
    create: XOR<
      FacilityToCoWorkCreateWithoutCoWorkInput,
      FacilityToCoWorkUncheckedCreateWithoutCoWorkInput
    >;
  };
  ...
  export type BookRoomCreateOrConnectWithoutCoworkInput = {
    where: BookRoomWhereUniqueInput;
    create: XOR<
      BookRoomCreateWithoutCoworkInput,
      BookRoomUncheckedCreateWithoutCoworkInput
    >;
  };
  ...
  export type BranchToRoomUpsertWithWhereUniqueWithoutCoWorkInput = {
    where: BranchToRoomWhereUniqueInput;
    update: XOR<
      BranchToRoomUpdateWithoutCoWorkInput,
      BranchToRoomUncheckedUpdateWithoutCoWorkInput
    >;
    create: XOR<
      BranchToRoomCreateWithoutCoWorkInput,
      BranchToRoomUncheckedCreateWithoutCoWorkInput
  ...
  export type BranchToRoomUpdateManyWithWhereWithoutCoWorkInput = {
    ...
    data: XOR<
      BranchToRoomUpdateManyMutationInput,
      BranchToRoomUncheckedUpdateManyWithoutBranchToRoomInput
    >;
  };
  ...
  export type FacilityToCoWorkUpsertWithWhereUniqueWithoutCoWorkInput = {
    where: FacilityToCoWorkWhereUniqueInput;
    update: XOR<
      FacilityToCoWorkUpdateWithoutCoWorkInput,
      FacilityToCoWorkUncheckedUpdateWithoutCoWorkInput
    >;
    create: XOR<
      FacilityToCoWorkCreateWithoutCoWorkInput,
      FacilityToCoWorkUncheckedCreateWithoutCoWorkInput
  ...
  export type FacilityToCoWorkUpdateManyWithWhereWithoutCoWorkInput = {
    ...
    data: XOR<
      FacilityToCoWorkUpdateManyMutationInput,
      FacilityToCoWorkUncheckedUpdateManyWithoutFacilityToCoWorkInput
    >;
  };
  ...
  export type BookRoomUpsertWithWhereUniqueWithoutCoworkInput = {
    where: BookRoomWhereUniqueInput;
    update: XOR<
      BookRoomUpdateWithoutCoworkInput,
      BookRoomUncheckedUpdateWithoutCoworkInput
    >;
    create: XOR<
      BookRoomCreateWithoutCoworkInput,
      BookRoomUncheckedCreateWithoutCoworkInput
  ...
  export type BranchToRoomCreateOrConnectWithoutRoomInput = {
    where: BranchToRoomWhereUniqueInput;
    create: XOR<
      BranchToRoomCreateWithoutRoomInput,
      BranchToRoomUncheckedCreateWithoutRoomInput
    >;
  };
  ...
  export type RoomRateCreateOrConnectWithoutRoomInput = {
    where: RoomRateWhereUniqueInput;
    create: XOR<
      RoomRateCreateWithoutRoomInput,
      RoomRateUncheckedCreateWithoutRoomInput
    >;
  };
  ...
  export type BranchToRoomUpsertWithWhereUniqueWithoutRoomInput = {
    where: BranchToRoomWhereUniqueInput;
    update: XOR<
      BranchToRoomUpdateWithoutRoomInput,
      BranchToRoomUncheckedUpdateWithoutRoomInput
    >;
    create: XOR<
      BranchToRoomCreateWithoutRoomInput,
      BranchToRoomUncheckedCreateWithoutRoomInput
  ...
  export type RoomRateUpsertWithWhereUniqueWithoutRoomInput = {
    where: RoomRateWhereUniqueInput;
    update: XOR<
      RoomRateUpdateWithoutRoomInput,
      RoomRateUncheckedUpdateWithoutRoomInput
    >;
    create: XOR<
      RoomRateCreateWithoutRoomInput,
      RoomRateUncheckedCreateWithoutRoomInput
  ...
  export type RoomRateUpdateManyWithWhereWithoutRoomInput = {
    ...
    data: XOR<
      RoomRateUpdateManyMutationInput,
      RoomRateUncheckedUpdateManyWithoutRoomRateInput
    >;
  };
  ...
  export type BookRoomCreateOrConnectWithoutRoomRateInput = {
    where: BookRoomWhereUniqueInput;
    create: XOR<
      BookRoomCreateWithoutRoomRateInput,
      BookRoomUncheckedCreateWithoutRoomRateInput
    >;
  };
  ...
  export type BookRoomUpsertWithWhereUniqueWithoutRoomRateInput = {
    where: BookRoomWhereUniqueInput;
    update: XOR<
      BookRoomUpdateWithoutRoomRateInput,
      BookRoomUncheckedUpdateWithoutRoomRateInput
    >;
    create: XOR<
      BookRoomCreateWithoutRoomRateInput,
      BookRoomUncheckedCreateWithoutRoomRateInput
  ...
  export type RoomRateCreateOrConnectWithoutDurationInput = {
    where: RoomRateWhereUniqueInput;
    create: XOR<
      RoomRateCreateWithoutDurationInput,
      RoomRateUncheckedCreateWithoutDurationInput
    >;
  };
  ...
  export type RoomRateUpsertWithWhereUniqueWithoutDurationInput = {
    where: RoomRateWhereUniqueInput;
    update: XOR<
      RoomRateUpdateWithoutDurationInput,
      RoomRateUncheckedUpdateWithoutDurationInput
    >;
    create: XOR<
      RoomRateCreateWithoutDurationInput,
      RoomRateUncheckedCreateWithoutDurationInput
  ...
  export type FacilityToCoWorkCreateOrConnectWithoutFacilityInput = {
    where: FacilityToCoWorkWhereUniqueInput;
    create: XOR<
      FacilityToCoWorkCreateWithoutFacilityInput,
      FacilityToCoWorkUncheckedCreateWithoutFacilityInput
    >;
  };
  ...
  export type FacilityToCoWorkUpsertWithWhereUniqueWithoutFacilityInput = {
    where: FacilityToCoWorkWhereUniqueInput;
    update: XOR<
      FacilityToCoWorkUpdateWithoutFacilityInput,
      FacilityToCoWorkUncheckedUpdateWithoutFacilityInput
    >;
    create: XOR<
      FacilityToCoWorkCreateWithoutFacilityInput,
      FacilityToCoWorkUncheckedCreateWithoutFacilityInput
  ...
  export type BookRoomCreateOrConnectWithoutVertifyCodeInput = {
    where: BookRoomWhereUniqueInput;
    create: XOR<
      BookRoomCreateWithoutVertifyCodeInput,
      BookRoomUncheckedCreateWithoutVertifyCodeInput
    >;
  };
  ...
  export type BookRoomUpsertWithWhereUniqueWithoutVertifyCodeInput = {
    where: BookRoomWhereUniqueInput;
    update: XOR<
      BookRoomUpdateWithoutVertifyCodeInput,
      BookRoomUncheckedUpdateWithoutVertifyCodeInput
    >;
    create: XOR<
      BookRoomCreateWithoutVertifyCodeInput,
      BookRoomUncheckedCreateWithoutVertifyCodeInput
